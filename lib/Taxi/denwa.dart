...
class _State extends State<denwa> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonAppBar(
        title: Text('かけたい会社を選ぶ'), appBar: AppBar(),
      ),
      body: Container(
              ...
              children: <Widget>[
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text('あいづタクシー', style: TextStyle(fontSize: 35),),
                    onPressed: () {
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    color: Colors.orange,
                    textColor: Colors.white,
                    child: Text('白虎タクシー', style: TextStyle(fontSize: 35),),
                    onPressed: () {
                      showDialog(context: context,
                        builder: (_) => CupertinoAlertDialog(
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    color: Colors.orange,
                    textColor: Colors.white,
                    child: Text('若松タクシー', style: TextStyle(fontSize: 35),),
                    onPressed: () {
                    showDialog(context: context,
                        builder: (_) => CupertinoAlertDialog(
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    color: Colors.orange,
                    textColor: Colors.white,
                    child: Text('(資)広田タクシー', style: TextStyle(fontSize: 35),),
                    onPressed: () {
                      showDialog(context: context,
                          builder: (_) => CupertinoAlertDialog(
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    color: Colors.orange,
                    textColor: Colors.white,
                    child: Text('葵観光タクシー', style: TextStyle(fontSize: 35),),
                    onPressed: () {
                      showDialog(context: context,
                          builder: (_) => CupertinoAlertDialog(
                ...
                Text(_status, style: TextStyle(color: Colors.black,fontSize: 17,backgroundColor: Colors.white),)
              ],
            ),
          ),
        ),
